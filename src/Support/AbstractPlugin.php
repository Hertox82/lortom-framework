...
abstract class AbstractPlugin
{
    ...
    protected function compilePlugin($data,$delete = false)
    {
        ...
        $this->configCompiler->write($data,$this->vendor,$this->name,$i);
    }
    ...
    {
        return $this->configCompiler->getArrayDataPlugins();
    }
    ...
    {
        return $this->configCompiler->getIndexFromPlugins($this->getArrayDataPlugins()['plugins'],$this->vendor,$this->name);
    }
    ...
    {
        $this->configCompiler->updatePermission($this->vendor,$this->name);
    }


    protected function migrationUpByCompiler()
    {
        $this->configCompiler->migration($this->vendor,$this->name,'migration-up');
    }

    protected function migrationDownByCompiler()
    {
        $this->configCompiler->migration($this->vendor,$this->name,'migration-down');
    }
