...
use LTFramework\Template\Compiler\TemplatePlugCompiler;
...
class AddTempPlugin extends Command{
     ...
     * @var string
     */
    protected $signature = "lt-template:add-plugin {--vendor-name= : Pass the Vendor,Name for your Template!} {--silent} {--name-plugin= : Pass the Vendor, Name of Plugin}";
    ...
    /**
     * @var \LTFramework\Template\Compiler\TemplatePlugCompiler;
     */
    protected $compiler;
