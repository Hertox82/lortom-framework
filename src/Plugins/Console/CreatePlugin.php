...
use LTFramework\Plugins\Compiler\PluginCreateCompiler;
...
class CreatePlugin extends Command
{
     ...
     * @var string
     */
    protected $signature = 'lt-plugin:create {--vendor-name= : Pass the Vendor,Name for your plugin!}';

    protected $description = 'In Order to create a plugin digit --vendor-name=Vendor,Name';

    /**
     * @var \LTFramework\Plugins\Compiler\PluginCreateCompiler
     */
    protected $compiler;
