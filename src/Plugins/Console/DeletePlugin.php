...
use LTFramework\Plugins\Compiler\PluginDeleteCompiler;
use Illuminate\Console\Command;
use File;

class DeletePlugin extends Command
{
    protected $signature = "lt-plugin:delete {--vendor-name= : This is the safe mode to delete plugin in Lortom} {--silent}";


    protected $description = "This command delete all folder and clean all configuration from your Plugin";

    /**
     * @var \LTFramework\Plugins\Compiler\PluginDeleteCompiler
     */
    protected $compiler;
