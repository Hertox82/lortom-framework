...
class TemplateCreateCompiler extends AbstractTemplateCompiler {
    ...
    /**
     * This function create Resources Folder with the basics file
     * @param $path
     */
    public function makingResourcesFolder($path) {

        //this function generate all ResourcesFolder
        $this->generateResourcesFolder($path);

        //this function compile welcome.blade.php
        $this->compileWelcomeView();

        //this function compile CSS file
        $this->compileCssFile();

    }

    /**
     * This function generate folder for the Resources
     * @param $path
     */
    protected function generateResourcesFolder($path) {

        // resources folder
        $this->createDirIfNotExist($this->resourcesFolder = $path.$this->resources);

        $this->createDirIfNotExist($this->assetsFolder = $this->resourcesFolder.'/assets');
        // asset css
        $this->createDirIfNotExist($this->cssFolder = $this->assetsFolder.'/css');
        // asset js
        $this->createDirIfNotExist($this->jsFolder = $this->assetsFolder.'/js');
        //create folder for views
        $this->createDirIfNotExist( $this->viewFolder = $this->resourcesFolder.'/views');
        // create database folder
        $this->createDirIfNotExist($this->databaseFolder = $this->resourcesFolder.'/database');
        // create migrations folder
        $this->createDirIfNotExist($this->migrationsFolder = $this->databaseFolder.'/migrations');
        // create seeder folder
        $this->createDirIfNotExist($this->seederFolder = $this->databaseFolder.'/seeder');
    }

    /**
     * This function compile the welcome.blade.php view
     */
    protected function compileWelcomeView() {

        $this->compile($this->viewFolder.'/welcome.blade.php',$this->setStub(__DIR__.'/stub/template/welcome.blade.php.stub')
            ->getStub());
    }

    /**
     * This function compile the css file
     */
    protected function compileCssFile() {
        $this->compile($this->cssFolder.'/style.css','/*This is autogenerated css*/');
    }
