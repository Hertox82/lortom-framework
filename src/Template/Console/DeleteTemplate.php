...
use LTFramework\Template\Compiler\TemplateDeleteCompiler;
...
class DeleteTemplate extends Command{
    ...
    protected $signature = "lt-template:delete {--vendor-name= : Pass the Vendor,Name to delete a Template!} {--silent}";

    protected $description = "In Order to delete a template digit --vendor-name=Vendor,Name";

    /**
     * @var \LTFramework\Template\Compiler\TemplateDeleteCompiler
     */
    protected $compiler;
